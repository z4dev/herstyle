  ...
  return (
    <footer className="bg-purple text-white p-8 text-right ">
      <div className="container mx-auto grid grid-cols-1 md:grid-cols-3 gap-8">
        <div className="text-right ">
          ...
          <div className="flex justify-end space-x-2 space-x-reverse">
            <Image className="mr-2 hover:opacity-80" src="/mada.png" alt="mada" width={40} height={25} />
            <Image className="hover:opacity-80" src="/visa.png" alt="Visa" width={40} height={25} />
          </div>
          ...
          <div className="flex justify-end space-x-2 space-x-reverse">
            ...
            <Link href="https://snapchat.com/t/sq45IYG3" className="mr-2 hover:text-black">
            ...
            <Link href="http://www.tiktok.com/@herstylee.9" className="hover:text-black">
            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="currentColor">
              <path d="M19.59 6.69a4.83 4.83 0 0 1-3.77-4.25V2h-3.45v13.67a2.89 2.89 0 0 1-5.2 1.74 2.89 2.89 0 0 1 2.31-4.64 2.93 2.93 0 0 1 .88.13V9.4a6.84 6.84 0 0 0-1-.05A6.33 6.33 0 0 0 5 20.1a6.34 6.34 0 0 0 10.86-4.43v-7a8.16 8.16 0 0 0 4.77 1.52v-3.4a4.85 4.85 0 0 1-1-.1z" />
            </svg>
            </Link>
            <Link href="https://www.instagram.com/herstyle.9?igsh=NDR0N3J1amg3dWZh&utm_source=qr" className="hover:text-black">
            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="currentColor">
      ...
      <div className="mt-8 text-center">
        <Link href="https://rab-t.com/" className="text-center hover:text-black hover:underline">جميع الحقوق محفوظة لدى ( مؤسسة ربط الخيال )</Link>
      </div>
    </footer>
  );
}
